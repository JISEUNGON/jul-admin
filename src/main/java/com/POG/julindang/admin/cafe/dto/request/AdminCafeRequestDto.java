...
public class AdminCafeRequestDto {
    ...
    @Builder
    public AdminCafeRequestDto(Long id, String cafeName, String beverageName, String size, Double serve, Double sugar, Double calorie, Boolean temperature, Boolean deleted, String manager) {
        this.id = id;
    ...
    public AdminCafeRequestDto(Cafe cafe) {
