...
@Setter
@NoArgsConstructor
public class AdminCafeResponseDto {
    private Long id;
    ...
    @Builder
    public AdminCafeResponseDto(Long id, String cafeName, String beverageName, String size, Double serve, Double sugar, Double calorie, Boolean temperature, Boolean deleted, String manager) {
        this.id = id;
    ...
    public AdminCafeResponseDto(Cafe cafe) {
